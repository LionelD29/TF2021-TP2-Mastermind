...
export class GameComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.settings.gameMode === 'solo') {
      ...
      alert('Mode: singleplayer\nA secret combination of 4 colors has been generated by the computer.\nGood luck!')
    } else {
      alert('Mode: multiplayer\nPlayer 2 must generate a secret combination of 4 colors that player 1 will try to find in ' + this.settings.maxNbAttempts + ' attempt(s)');
    }
  }
  ...
  onAddAttemptCombination(combination: Combination): void {
    if (this.solution.length === 0 && this.settings.gameMode === 'multi') { // Selection of the solution by a player
      ...
      alert('A combination has been chosen by player 2');
    } else {
